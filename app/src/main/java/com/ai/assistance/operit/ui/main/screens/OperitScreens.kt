...
import com.ai.assistance.operit.ui.features.car.CarHomeScreen
...
import com.ai.assistance.operit.ui.features.settings.screens.CarSettingsScreen
...
sealed class Screen(
    ...
    // 车机主界面 - 语音悬浮窗模式作为主界面
    data object CarHome : Screen(navItem = NavItem.AiChat, participatesInCrossfadeTransition = false) {
        @Composable
        override fun Content(
                navController: NavController,
                navigateTo: ScreenNavigationHandler,
            ...
            CarHomeScreen(
                onNavigateToChat = { navigateTo(AiChat) },
                onNavigateToSettings = { navigateTo(Settings) }
            )
        }
    }
    ...
    data object Settings : Screen(navItem = NavItem.Settings) {
        ...
        override fun Content(
            ...
            SettingsScreen(
                    ...
                    navigateToCarSettings = { navigateTo(CarSettings) }
            )
        }
    }
    ...
    // 车机设置页面
    data object CarSettings :
            Screen(navItem = NavItem.Settings, titleRes = R.string.screen_title_car_settings) {
        @Composable
        override fun Content(
                navController: NavController,
                navigateTo: ScreenNavigationHandler,
            ...
            CarSettingsScreen(onNavigateBack = onGoBack)
        }
    }
